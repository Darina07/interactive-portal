                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    @foreach($users as $user)
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$user->phone}}</th>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200 flex" aria-labelledby="apple-imac-27-dropdown-button">
                                    <li>
                                        <a href="/employer/{{$user->id}}"  class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                    </li>
                                    <li class="flex">
