        ...
        <form method="POST">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    ...
                    <x-text-input  id="euser_name" class="block mt-1 w-full" type="text" name="name" required autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <x-text-input id="euser_phone" class="block mt-1 w-full" type="text" name="phone" required autofocus autocomplete="username" />
            ...
            @if (session('success'))
                <div class="alert alert-success text-green-700 mt-3">{{ session('success') }}</div>
            @endif
        </form>
    </div>
    </div>
